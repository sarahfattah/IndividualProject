...
const Supersector_Code ={
  ...
  registrationkey= "";
  if (registrationkey==""){
    console.log("Please enter a registrationkey in the JavaScript code. You can register for an API key at https://www.bls.gov/developers/ ");
  }
  let startquery= "https://api.bls.gov/publicAPI/v2/timeseries/data/CEU";
  let endquery= "000001?" + registrationkey;
